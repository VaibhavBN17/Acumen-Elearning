...
import { ADD_PRODUCT_SUCCESS, ADD_QUIZ_QUESTIONS, ADD_User_SUCCESS, ADD_Video_SUCCESS, GET_PRODUCT_SUCCESS, GET_User_SUCCESS, GET_Video_SUCCESS, PATCH_PRODUCT_SUCCESS, PATCH_User_SUCCESS, PRODUCT_FAILURE, PRODUCT_REQUEST } from "./actionType"
...
// export const addQuizQuestions = (data) => (dispatch) => {
//   dispatch({ type: ADD_QUIZ_QUESTIONS });
//   axios.fetch(`http://localhost:8080/quiz/add`, {
//     method: "POST",
//     headers: {
//       "Content-Type": "application/json",
//       Authorization: `Bearer ${token}`
//     },
//     body: JSON.stringify(data)
//   }).then((res) => { console.log(res, "quiz addedd"); alert("Quiz added Successfuly") });
// }
...
export const addQuizQuestions = (data) => (dispatch) => {
  ...
  fetch(`http://localhost:8080/quiz/add`, {
    ...
    console.log(res, "quiz addedd"); alert("Quiz added Successfuly")
  }).catch(e => console.log(e))
}
